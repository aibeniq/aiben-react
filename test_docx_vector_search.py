...
def create_test_docx():
    ...
    try:
        ...
        doc.add_paragraph("Effective leadership skills are crucial in AI development and implementation.")
        doc.add_paragraph("Key leadership qualities include:")
        
        # Add a list
        doc.add_paragraph("• Strategic thinking and vision", style='List Bullet')
        doc.add_paragraph("• Technical expertise combined with business acumen", style='List Bullet')
        ...
        doc.add_paragraph("AI leaders must understand and mitigate various risks including:")
...
def test_docx_vector_search():
    ...
    try:
        ...
        with open(docx_path, 'rb') as f:
            files = {'files': ('test_leadership.docx', f, 'application/vnd.openxmlformats-officedocument.wordprocessingml.document')}
