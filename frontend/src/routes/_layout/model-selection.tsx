...
function LlmModels() {
  ...
  const setDefaultMutation = useMutation({
    ...
    onError: (error) => {
      showErrorToast(
        t("toast.defaultModelUpdateFailed", { error: error.message }),
      )
    },
  })
                ...
                >
                  ...
                  <Dialog.Body>
                    <VStack gap={4}>
                      ...
                      <Field
                        label={t("modelSelection.dialog.modelId")}
                        required
                      >
                        <HStack>
                          <Input
                            ...
                            placeholder={t(
                              "modelSelection.placeholders.embeddingModelId",
                            )}
                          />
                          <Button
                      ...
                      <Field label={t("modelSelection.dialog.description")}>
                        <Textarea
                          ...
                          placeholder={t(
                            "modelSelection.placeholders.describeModel",
                          )}
                          rows={3}
                        />
                      </Field>
