              ...
              <Card.Body p={2}>
                <VStack align="stretch" spacing={2} maxH="500px" overflowY="auto">
                  {isHistoryLoading ? (
                    ...
                    <Text fontSize="sm" color="gray.500">No previous form processing</Text>
                  ) : (
                      ...
                      >
                        <VStack align="start" spacing={1} width="100%">
                          <HStack spacing={1} width="100%" justify="space-between">
                            ...
                            {item?.has_feedback && (
                              <Box as={FiCheckCircle} size="14px" color="green.500" title="Has feedback" />
                            )}
                          </HStack>
                    ...
                    {selectedHistoryItem?.id && (
                      ...
                      >
                        <FeedbackButtons 
                          ...
                          existingFeedback={selectedHistoryItem.feedback ? {
                            feedback: selectedHistoryItem.feedback.feedback as "correct" | "incorrect" | null,
