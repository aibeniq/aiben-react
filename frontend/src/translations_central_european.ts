...
export const addCentralEuropeanTranslations = (resources: any) => {
  ...
  resources.cs = {
    ...
    generate: {
      pageDescription:
        "Vygenerujte dokument na základě uživatelem definovaného osnovy a databáze dokumentů.",
      generatingDocument: "Generování dokumentu...",
      pleaseWait: "Čekejte prosím, než vygenerujeme vaši zprávu",
      knowledgeBaseTitle: "Znalostní báze",
      documentOutlineTitle: "Osnova dokumentu",
      clickToSelect: "Kliknutím vyberte",
      customInstructionsTitle: "Vlastní instrukce (volitelné)",
      customInstructionsPlaceholder:
        "Zadejte jakékoli další instrukce, které by měly být zváženy při generování každé části zprávy...",
      characterCount:
        "{{count}}/2000 znaků. Tyto instrukce budou přidány do výzvy při generování každé části.",
      selectKnowledgeBaseTitle: "Vyberte znalostní bázi",
      selectDocumentOutlineTitle: "Vyberte osnovu dokumentu",
      ...
      enterAtLeastOneSection: "Zadejte prosím alespoň jednu část",
      selectKnowledgeBase: "Vyberte prosím znalostní bázi",
      generateSuccess: "Zpráva úspěšně vygenerována!",
      matchSuccess: "Zpracování formuláře úspěšně dokončeno!",
      generateError: "Nepodařilo se vygenerovat dokument: {error}",
      vectorSearch: "vektorové vyhledávání",
      fullDocumentScan: "úplné skenování dokumentu",
      editOutline: "Upravit osnovu",
    },
  }
  ...
  resources.sk = {
    ...
    generate: {
      pageDescription:
        "Vygenerujte dokument na základe používateľom definovaného osnovy a databázy dokumentov.",
      generatingDocument: "Generovanie dokumentu...",
      pleaseWait: "Čakajte prosím, kým vygenerujeme vašu správu",
      knowledgeBaseTitle: "Znalostná báza",
      documentOutlineTitle: "Osnova dokumentu",
      clickToSelect: "Kliknutím vyberte",
      customInstructionsTitle: "Vlastné inštrukcie (voliteľné)",
      customInstructionsPlaceholder:
        "Zadajte akékoľvek ďalšie inštrukcie, ktoré by sa mali zvážiť pri generovaní každej časti správy...",
      characterCount:
        "{{count}}/2000 znakov. Tieto inštrukcie budú pridané do výzvy pri generovaní každej časti.",
      selectKnowledgeBaseTitle: "Vyberte znalostnú bázu",
      selectDocumentOutlineTitle: "Vyberte osnovu dokumentu",
      ...
      enterAtLeastOneSection: "Zadajte prosím aspoň jednu časť",
      selectKnowledgeBase: "Vyberte prosím znalostnú bázu",
      generateSuccess: "Správa úspešne vygenerovaná!",
      matchSuccess: "Spracovanie formulára úspešne dokončené!",
      generateError: "Nepodarilo sa vygenerovať dokument: {error}",
      vectorSearch: "vektorové vyhľadávanie",
      fullDocumentScan: "úplné skenovanie dokumentu",
      editOutline: "Upraviť osnovu",
    },
  }
  ...
  resources.hu = {
    ...
    generate: {
      pageDescription:
        "Dokumentum generálása felhasználó által definiált vázlat és dokumentum adatbázis alapján.",
      generatingDocument: "Dokumentum generálása...",
      pleaseWait: "Kérjük, várjon, amíg elkészítjük a jelentését",
      knowledgeBaseTitle: "Tudásbázis",
      documentOutlineTitle: "Dokumentum vázlat",
      clickToSelect: "Kattintson a kiválasztáshoz",
      customInstructionsTitle: "Egyéni utasítások (opcionális)",
      customInstructionsPlaceholder:
        "Adjon meg bármilyen további utasítást, amelyet figyelembe kell venni a jelentés egyes szakaszainak generálásakor...",
      characterCount:
        "{{count}}/2000 karakter. Ezek az utasítások hozzáadódnak minden szakasz generálásakor.",
      selectKnowledgeBaseTitle: "Tudásbázis kiválasztása",
      selectDocumentOutlineTitle: "Dokumentum vázlat kiválasztása",
      ...
      downloadCsv: "CSV letöltése",
      clearReport: "Jelentés törlése",
      resultsPlaceholder:
        "Az eredmények a dokumentum generálása után itt jelennek meg.",
      sectionsWithSources: "Szakaszok forrásokkal",
      sectionNumber: "Szakasz {number}: {title}",
      kbGenerated: "KB által generált",
      rawText: "Nyers szöveg",
      viewSourceCitations: "Forrás hivatkozások megtekintése ({count})",
      documentCopiedSuccess: "Dokumentum másolva a vágólapra",
      documentCopiedError: "Nem sikerült a dokumentum másolása a vágólapra",
      documentDownloadSuccess: "Dokumentum sikeresen letöltve",
      documentDownloadError: "Nem sikerült a dokumentum letöltése: {error}",
      csvDownloadSuccess: "CSV sikeresen letöltve",
      csvDownloadError: "Nem sikerült a CSV letöltése: {error}",
      reportClearedSuccess: "Generált jelentés törölve",
      enterAtLeastOneSection: "Kérjük, adjon meg legalább egy szakaszt",
      selectKnowledgeBase: "Kérjük, válasszon tudásbázist",
      generateSuccess: "Jelentés sikeresen generálva!",
      matchSuccess: "Űrlap feldolgozása sikeresen befejezve!",
      generateError: "Nem sikerült a dokumentum generálása: {error}",
      vectorSearch: "vektor keresés",
      fullDocumentScan: "teljes dokumentum vizsgálat",
      editOutline: "Vázlat szerkesztése",
    },
  }
  ...
  resources.ro = {
    ...
    generate: {
      ...
      customInstructionsTitle: "Instrucțiuni Personalizate (Opțional)",
      customInstructionsPlaceholder:
        "Introduceți orice instrucțiuni suplimentare care ar trebui luate în considerare la generarea fiecărei secțiuni a raportului...",
      characterCount:
        "{{count}}/2000 caractere. Aceste instrucțiuni vor fi adăugate la prompt când se generează fiecare secțiune.",
      selectKnowledgeBaseTitle: "Selectați Baza de Cunoștințe",
      selectDocumentOutlineTitle: "Selectați Conturul Documentului",
      generateButton: "Generați",
      results: "Rezultate",
      copyText: "Copiați Textul",
      copied: "Copiat!",
      downloadDocx: "Descărcați DOCX",
      downloadCsv: "Descărcați CSV",
      clearReport: "Ștergeți Raportul",
      resultsPlaceholder:
        "Rezultatele vor apărea aici după generarea documentului.",
      sectionsWithSources: "Secțiuni cu Surse",
      sectionNumber: "Secțiunea {number}: {title}",
      kbGenerated: "Generat KB",
      rawText: "Text brut",
      viewSourceCitations: "Vizualizați Citările Sursei ({count})",
      documentCopiedSuccess: "Document copiat în clipboard",
      documentCopiedError: "Nu s-a putut copia documentul în clipboard",
      documentDownloadSuccess: "Document descărcat cu succes",
      documentDownloadError: "Nu s-a putut descărca documentul: {error}",
      csvDownloadSuccess: "CSV descărcat cu succes",
      csvDownloadError: "Nu s-a putut descărca CSV: {error}",
      reportClearedSuccess: "Raport generat șters",
      enterAtLeastOneSection: "Vă rugăm introduceți cel puțin o secțiune",
      selectKnowledgeBase: "Vă rugăm selectați o bază de cunoștințe",
      generateSuccess: "Raport generat cu succes!",
      matchSuccess: "Procesarea formularului finalizată cu succes!",
      generateError: "Nu s-a putut genera documentul: {error}",
      vectorSearch: "căutare vectorială",
      fullDocumentScan: "scanare completă a documentului",
      editOutline: "Editați Conturul",
    },
    feedback: {
      modalTitlePositive: "Ce a fost util?",
      modalTitleNegative: "Ce ar putea fi îmbunătățit?",
      descriptionPositive: "Spuneți-ne ce v-a plăcut la acest răspuns.",
      descriptionNegative: "Spuneți-ne cum putem îmbunătăți acest răspuns.",
      placeholder: "Comentariile dumneavoastră (opțional)",
      cancel: "Anulare",
      updateFeedback: "Actualizați feedback-ul",
      submit: "Trimiteți",
  ...
  resources.bg = {
    ...
    generate: {
      pageDescription:
        "Генерирайте документ въз основа на дефинирана от потребителя структура и база данни с документи.",
      generatingDocument: "Генериране на документ...",
      pleaseWait: "Моля, изчакайте докато генерираме вашия отчет",
      knowledgeBaseTitle: "База Знания",
      documentOutlineTitle: "Структура на Документа",
      clickToSelect: "Кликнете за избор",
      customInstructionsTitle: "Персонализирани Инструкции (По избор)",
      customInstructionsPlaceholder:
        "Въведете всякакви допълнителни инструкции, които трябва да се вземат предвид при генерирането на всяка секция на отчета...",
      characterCount:
        "{{count}}/2000 знака. Тези инструкции ще бъдат добавени към подканата при генерирането на всяка секция.",
      selectKnowledgeBaseTitle: "Изберете База Знания",
      selectDocumentOutlineTitle: "Изберете Структура на Документа",
      ...
      downloadCsv: "Изтегли CSV",
      clearReport: "Изчисти Отчет",
      resultsPlaceholder:
        "Резултатите ще се появят тук след генерирането на документа.",
      sectionsWithSources: "Секции с Източници",
      sectionNumber: "Секция {number}: {title}",
      kbGenerated: "Генерирано от KB",
      rawText: "Необработен текст",
      viewSourceCitations: "Виж Цитатите на Източника ({count})",
      documentCopiedSuccess: "Документът е копиран в клипборда",
      documentCopiedError: "Неуспешно копиране на документа в клипборда",
      documentDownloadSuccess: "Документът е изтеглен успешно",
      documentDownloadError: "Неуспешно изтегляне на документа: {error}",
      csvDownloadSuccess: "CSV е изтеглен успешно",
      csvDownloadError: "Неуспешно изтегляне на CSV: {error}",
      reportClearedSuccess: "Генерираният отчет е изчистен",
      enterAtLeastOneSection: "Моля, въведете поне една секция",
      selectKnowledgeBase: "Моля, изберете база знания",
      generateSuccess: "Отчетът е генериран успешно!",
      matchSuccess: "Обработката на формуляра е завършена успешно!",
      generateError: "Неуспешно генериране на документа: {error}",
      vectorSearch: "векторно търсене",
      fullDocumentScan: "пълно сканиране на документа",
      editOutline: "Редактирай Структурата",
    },
    feedback: {
      modalTitlePositive: "Какво беше полезно?",
      modalTitleNegative: "Какво може да се подобри?",
      descriptionPositive: "Кажете ни какво харесахте в този отговор.",
      descriptionNegative: "Кажете ни как можем да подобрим този отговор.",
      placeholder: "Вашите коментари (по избор)",
      cancel: "Отказ",
      updateFeedback: "Актуализирай обратната връзка",
      submit: "Изпрати",
      tooltipEditPositive: "Редактирай полезната си обратна връзка",
      tooltipMarkPositive: "Маркирай като полезно",
      tooltipEditNegative: "Редактирай обратната си връзка за подобрения",
  ...
  resources.hr = {
    ...
    generate: {
      pageDescription:
        "Generirajte dokument na temelju korisnički definirane strukture i baze podataka dokumenata.",
      generatingDocument: "Generiranje dokumenta...",
      pleaseWait: "Molimo pričekajte dok generiramo vaš izvještaj",
      knowledgeBaseTitle: "Baza Znanja",
      documentOutlineTitle: "Struktura Dokumenta",
      clickToSelect: "Kliknite za odabir",
      customInstructionsTitle: "Prilagođene Upute (Opcionalno)",
      customInstructionsPlaceholder:
        "Unesite bilo koje dodatne upute koje bi se trebale razmotriti pri generiranju svakog odjeljka izvješća...",
      characterCount:
        "{{count}}/2000 znakova. Ove će se upute dodati u prompt pri generiranju svakog odjeljka.",
      selectKnowledgeBaseTitle: "Odaberite Bazu Znanja",
      selectDocumentOutlineTitle: "Odaberite Strukturu Dokumenta",
      ...
      downloadCsv: "Preuzmi CSV",
      clearReport: "Očisti Izvješće",
      resultsPlaceholder:
        "Rezultati će se pojaviti ovdje nakon generiranja dokumenta.",
      sectionsWithSources: "Odjeljci s Izvorima",
      sectionNumber: "Odjeljak {number}: {title}",
      kbGenerated: "Generirano KB",
      rawText: "Neobrađeni tekst",
      viewSourceCitations: "Prikaži Citiranja Izvora ({count})",
      documentCopiedSuccess: "Dokument kopiran u međuspremnik",
      documentCopiedError: "Nije uspjelo kopiranje dokumenta u međuspremnik",
      documentDownloadSuccess: "Dokument uspješno preuzet",
      documentDownloadError: "Nije uspjelo preuzimanje dokumenta: {error}",
      csvDownloadSuccess: "CSV uspješno preuzet",
      csvDownloadError: "Nije uspjelo preuzimanje CSV-a: {error}",
      reportClearedSuccess: "Generirano izvješće očišćeno",
      enterAtLeastOneSection: "Molimo unesite barem jedan odjeljak",
      selectKnowledgeBase: "Molimo odaberite bazu znanja",
      generateSuccess: "Izvješće uspješno generirano!",
      matchSuccess: "Obrada obrasca uspješno završena!",
      generateError: "Nije uspjelo generiranje dokumenta: {error}",
      vectorSearch: "vektorsko pretraživanje",
      fullDocumentScan: "potpuno skeniranje dokumenta",
      editOutline: "Uredi Strukturu",
    },
    feedback: {
      modalTitlePositive: "Što je bilo korisno?",
      modalTitleNegative: "Što se može poboljšati?",
      descriptionPositive: "Recite nam što vam se svidjelo u ovom odgovoru.",
      descriptionNegative: "Recite nam kako možemo poboljšati ovaj odgovor.",
      placeholder: "Vaši komentari (neobavezno)",
      cancel: "Odustani",
      updateFeedback: "Ažuriraj povratne informacije",
      submit: "Pošalji",
      tooltipEditPositive: "Uredite svoje korisne povratne informacije",
      tooltipMarkPositive: "Označi kao korisno",
      tooltipEditNegative: "Uredite svoje povratne informacije za poboljšanja",
  ...
  resources.sr = {
    ...
    generate: {
      pageDescription:
        "Генеришите документ на основу кориснички дефинисане структуре и базе података докумената.",
      generatingDocument: "Генерисање документа...",
      pleaseWait: "Молимо сачекајте док генеришемо ваш извештај",
      knowledgeBaseTitle: "База Знања",
      documentOutlineTitle: "Структура Документа",
      clickToSelect: "Кликните за избор",
      customInstructionsTitle: "Прилагођена Упутства (Опционално)",
      customInstructionsPlaceholder:
        "Унесите било која додатна упутства која би требало размотрити при генерисању сваког одељка извештаја...",
      characterCount:
        "{{count}}/2000 знакова. Ова упутства ће бити додата у промпт при генерисању сваког одељка.",
      selectKnowledgeBaseTitle: "Изаберите Базу Знања",
      selectDocumentOutlineTitle: "Изаберите Структура Документа",
      generateButton: "Генериши",
      results: "Резултати",
      copyText: "Копирај Текст",
      copied: "Копирано!",
      downloadDocx: "Преузми DOCX",
      downloadCsv: "Преузми CSV",
      clearReport: "Очисти Извештај",
      resultsPlaceholder:
        "Резултати ће се појавити овде након генерисања документа.",
      sectionsWithSources: "Одељци са Изворима",
      sectionNumber: "Одељак {number}: {title}",
      kbGenerated: "Генерисано KB",
      rawText: "Необрађени текст",
      viewSourceCitations: "Прикажи Цитирања Извора ({count})",
      documentCopiedSuccess: "Документ копиран у међуспремник",
      documentCopiedError: "Није успело копирање документа у међуспремник",
      documentDownloadSuccess: "Документ успешно преузет",
      documentDownloadError: "Није успело преузимање документа: {error}",
      csvDownloadSuccess: "CSV успешно преузет",
      csvDownloadError: "Није успело преузимање CSV-а: {error}",
      reportClearedSuccess: "Генерисани извештај очишћен",
      enterAtLeastOneSection: "Молимо унесите бар један одељак",
      selectKnowledgeBase: "Молимо изаберите базу знања",
      generateSuccess: "Извештај успешно генерисан!",
      matchSuccess: "Обрада обрасца успешно завршена!",
      generateError: "Није успело генерисање документа: {error}",
      vectorSearch: "векторско претраживање",
      fullDocumentScan: "потпуно скенирање документа",
      editOutline: "Уреди Структура",
    },
    feedback: {
      modalTitlePositive: "Шта је било корисно?",
      modalTitleNegative: "Шта се може побољшати?",
      descriptionPositive: "Реците нам шта вам се свидело у овом одговору.",
      descriptionNegative: "Реците нам како можемо побољшати овај одговор.",
      placeholder: "Ваши коментари (опционо)",
      cancel: "Откажи",
      updateFeedback: "Ажурирај повратне информације",
      submit: "Пошаљи",
      tooltipEditPositive: "Уредите своје корисне повратне информације",
      tooltipMarkPositive: "Означи као корисно",
      tooltipEditNegative: "Уредите своје повратне информације за побољшања",
  ...
  resources.sl = {
    ...
    generate: {
      pageDescription:
        "Ustvarite dokument na podlagi uporabniško določene strukture in baze podatkov dokumentov.",
      generatingDocument: "Ustvarjanje dokumenta...",
      pleaseWait: "Prosimo, počakajte, da ustvarimo vaše poročilo",
      knowledgeBaseTitle: "Baza Znanja",
      documentOutlineTitle: "Struktura Dokumenta",
      clickToSelect: "Kliknite za izbiro",
      customInstructionsTitle: "Prilagojena Navodila (Neobvezno)",
      customInstructionsPlaceholder:
        "Vnesite morebitna dodatna navodila, ki bi jih bilo treba upoštevati pri ustvarjanju vsakega razdelka poročila...",
      characterCount:
        "{{count}}/2000 znakov. Ta navodila bodo dodana v poziv pri ustvarjanju vsakega razdelka.",
      selectKnowledgeBaseTitle: "Izberite Bazo Znanja",
      selectDocumentOutlineTitle: "Izberite Strukturo Dokumenta",
      ...
      downloadCsv: "Prenesi CSV",
      clearReport: "Počisti Poročilo",
      resultsPlaceholder:
        "Rezultati se bodo prikazali tukaj po ustvarjanju dokumenta.",
      sectionsWithSources: "Razdelki z Viri",
      sectionNumber: "Razdelek {number}: {title}",
      kbGenerated: "Ustvarjeno KB",
      rawText: "Surovo besedilo",
      viewSourceCitations: "Prikaži Citiranja Vira ({count})",
      documentCopiedSuccess: "Dokument kopiran v odložišče",
      documentCopiedError: "Kopiranje dokumenta v odložišče ni uspelo",
      documentDownloadSuccess: "Dokument uspešno prenesen",
      documentDownloadError: "Prenos dokumenta ni uspel: {error}",
      csvDownloadSuccess: "CSV uspešno prenesen",
      csvDownloadError: "Prenos CSV-ja ni uspel: {error}",
      reportClearedSuccess: "Ustvarjeno poročilo počščeno",
      enterAtLeastOneSection: "Prosimo, vnesite vsaj en razdelek",
      selectKnowledgeBase: "Prosimo, izberite bazo znanja",
      generateSuccess: "Poročilo uspešno ustvarjeno!",
      matchSuccess: "Obdelava obrazca uspešno zaključena!",
      generateError: "Ustvarjanje dokumenta ni uspelo: {error}",
      vectorSearch: "vektorsko iskanje",
      fullDocumentScan: "popolno skeniranje dokumenta",
      editOutline: "Uredi Strukturo",
    },
  }
  ...
  if (!resources.hu.common.archive) {
    resources.hu.common.archive = {
      ...
      feedback: {
        ...
        submit: "Küldés",
        tooltipEditPositive: "Szerkessze hasznos visszajelzését",
        tooltipMarkPositive: "Jelölje hasznosnak",
        tooltipEditNegative: "Szerkessze visszajelzését a javításokhoz",
  ...
  if (!resources.cs.common.archive) {
    resources.cs.common.archive = {
      ...
      feedback: {
        modalTitlePositive: "Co bylo užitečné?",
        modalTitleNegative: "Co by se dalo zlepšit?",
        descriptionPositive: "Řekněte nám, co se vám na této odpovědi líbilo.",
        descriptionNegative: "Řekněte nám, jak můžeme tuto odpověď zlepšit.",
        placeholder: "Vaše komentáře (volitelné)",
        cancel: "Zrušit",
        updateFeedback: "Aktualizovat zpětnou vazbu",
        submit: "Odeslat",
        tooltipEditPositive: "Upravit vaši užitečnou zpětnou vazbu",
        tooltipMarkPositive: "Označit jako užitečné",
        tooltipEditNegative: "Upravit vaši zpětnou vazbu pro zlepšení",
  ...
  if (!resources.sk.common.archive) {
    resources.sk.common.archive = {
      ...
      feedback: {
        ...
        cancel: "Zrušiť",
        updateFeedback: "Aktualizovať spätnú väzbu",
        submit: "Odoslať",
        tooltipEditPositive: "Upraviť vašu užitočnú spätnú väzbu",
        tooltipMarkPositive: "Označiť ako užitočné",
        tooltipEditNegative: "Upraviť vašu spätnú väzbu pre zlepšenie",
