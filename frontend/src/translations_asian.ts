...
export const addAsianTranslations = (resources: any) => {
  ...
  resources["zh-TW"] = {
    common: {
      ...
      review: {
        ...
        pleaseWait: "請稍候，我們正在檢查您的文件",
        reviewSuccess: "文件檢查成功完成！",
        reviewSuccessMultiple: "{{count}} 個文件已處理並優化上下文共享！",
      },
      compare: {
        title: "文件比較",
    ...
    generate: {
      ...
      knowledgeBaseTitle: "知識庫",
      documentOutlineTitle: "文檔結構",
      clickToSelect: "點擊選擇",
      customInstructionsTitle: "自定義說明（可選）",
      customInstructionsPlaceholder:
        "輸入在生成報告每個部分時應考慮的任何附加說明...",
      characterCount:
        "{{count}}/2000 字符。這些說明將在生成每個部分時添加到提示中。",
      selectKnowledgeBaseTitle: "選擇知識庫",
      selectDocumentOutlineTitle: "選擇文檔結構",
      generateButton: "生成",
      results: "結果",
      copyText: "複製文本",
      copied: "已複製！",
      ...
      kbGenerated: "KB 生成",
      rawText: "原始文本",
      viewSourceCitations: "查看來源引用 ({count})",
      documentCopiedSuccess: "文檔已複製到剪貼板",
      documentCopiedError: "複製文檔到剪貼板失敗",
      documentDownloadSuccess: "文檔下載成功",
      documentDownloadError: "下載文檔失敗：{error}",
      csvDownloadSuccess: "CSV 下載成功",
      csvDownloadError: "下載 CSV 失敗：{error}",
      reportClearedSuccess: "生成的報告已清除",
      enterAtLeastOneSection: "請輸入至少一個部分",
      selectKnowledgeBase: "請選擇知識庫",
      generateSuccess: "報告生成成功！",
      matchSuccess: "表單處理成功完成！",
      generateError: "生成文檔失敗：{error}",
      vectorSearch: "向量搜索",
      fullDocumentScan: "完整文檔掃描",
      editOutline: "編輯結構",
    },
  }
  ...
  resources.th = {
    ...
    generate: {
      ...
      knowledgeBaseTitle: "ฐานความรู้",
      documentOutlineTitle: "โครงสร้างเอกสาร",
      clickToSelect: "คลิกเพื่อเลือก",
      customInstructionsTitle: "คำแนะนำที่กำหนดเอง (ไม่บังคับ)",
      customInstructionsPlaceholder:
        "ป้อนคำแนะนำเพิ่มเติมที่ควรพิจารณาเมื่อสร้างแต่ละส่วนของรายงาน...",
      characterCount:
        "{{count}}/2000 ตัวอักษร คำแนะนำเหล่านี้จะถูกเพิ่มเข้าไปในคำแนะนำเมื่อสร้างแต่ละส่วน",
      selectKnowledgeBaseTitle: "เลือกฐานความรู้",
      selectDocumentOutlineTitle: "เลือกโครงสร้างเอกสาร",
      ...
      rawText: "ข้อความดิบ",
      viewSourceCitations: "ดูการอ้างอิงแหล่งที่มา ({count})",
      documentCopiedSuccess: "เอกสารถูกคัดลอกไปยังคลิปบอร์ด",
      documentCopiedError: "ไม่สามารถคัดลอกเอกสารไปยังคลิปบอร์ด",
      documentDownloadSuccess: "ดาวน์โหลดเอกสารสำเร็จ",
      documentDownloadError: "ดาวน์โหลดเอกสารไม่สำเร็จ: {error}",
      csvDownloadSuccess: "ดาวน์โหลด CSV สำเร็จ",
      csvDownloadError: "ดาวน์โหลด CSV ไม่สำเร็จ: {error}",
      reportClearedSuccess: "รายงานที่สร้างไว้ถูกล้างแล้ว",
      enterAtLeastOneSection: "กรุณาป้อนอย่างน้อยหนึ่งส่วน",
      selectKnowledgeBase: "กรุณาเลือกฐานความรู้",
      generateSuccess: "สร้างรายงานสำเร็จ!",
      matchSuccess: "การประมวลผลแบบฟอร์มเสร็จสิ้นสำเร็จ!",
      generateError: "สร้างเอกสารไม่สำเร็จ: {error}",
      vectorSearch: "การค้นหาเวกเตอร์",
      fullDocumentScan: "การสแกนเอกสารแบบเต็ม",
      editOutline: "แก้ไขโครงสร้าง",
    },
  }
  ...
  resources.vi = {
    ...
    generate: {
      pageDescription:
        "Tạo tài liệu dựa trên cấu trúc do người dùng định nghĩa và cơ sở dữ liệu tài liệu.",
      generatingDocument: "Đang tạo tài liệu...",
      pleaseWait: "Vui lòng đợi trong khi chúng tôi tạo báo cáo của bạn",
      knowledgeBaseTitle: "Cơ sở Kiến thức",
      documentOutlineTitle: "Cấu trúc Tài liệu",
      clickToSelect: "Nhấp để chọn",
      customInstructionsTitle: "Hướng dẫn Tùy chỉnh (Tùy chọn)",
      customInstructionsPlaceholder:
        "Nhập bất kỳ hướng dẫn bổ sung nào cần xem xét khi tạo từng phần của báo cáo...",
      characterCount:
        "{{count}}/2000 ký tự. Những hướng dẫn này sẽ được thêm vào lời nhắc khi tạo từng phần.",
      selectKnowledgeBaseTitle: "Chọn Cơ sở Kiến thức",
      selectDocumentOutlineTitle: "Chọn Cấu trúc Tài liệu",
      generateButton: "Tạo",
      results: "Kết quả",
      ...
      rawText: "Văn bản thô",
      viewSourceCitations: "Xem Trích dẫn Nguồn ({count})",
      documentCopiedSuccess: "Tài liệu đã được sao chép vào clipboard",
      documentCopiedError: "Không thể sao chép tài liệu vào clipboard",
      documentDownloadSuccess: "Tải xuống tài liệu thành công",
      documentDownloadError: "Tải xuống tài liệu thất bại: {error}",
      csvDownloadSuccess: "Tải xuống CSV thành công",
      csvDownloadError: "Tải xuống CSV thất bại: {error}",
      reportClearedSuccess: "Báo cáo đã tạo đã được xóa",
      enterAtLeastOneSection: "Vui lòng nhập ít nhất một phần",
      selectKnowledgeBase: "Vui lòng chọn cơ sở kiến thức",
      generateSuccess: "Tạo báo cáo thành công!",
      matchSuccess: "Xử lý biểu mẫu hoàn thành thành công!",
      generateError: "Tạo tài liệu thất bại: {error}",
      vectorSearch: "tìm kiếm vector",
      fullDocumentScan: "quét tài liệu đầy đủ",
      editOutline: "Chỉnh sửa Cấu trúc",
    },
  }
  ...
  resources.id = {
    ...
    generate: {
      pageDescription:
        "Buat dokumen berdasarkan struktur yang ditentukan pengguna dan basis data dokumen.",
      generatingDocument: "Membuat dokumen...",
      pleaseWait: "Harap tunggu sementara kami membuat laporan Anda",
      knowledgeBaseTitle: "Basis Pengetahuan",
      documentOutlineTitle: "Struktur Dokumen",
      clickToSelect: "Klik untuk memilih",
      customInstructionsTitle: "Instruksi Kustom (Opsional)",
      customInstructionsPlaceholder:
        "Masukkan instruksi tambahan apa pun yang perlu dipertimbangkan saat membuat setiap bagian laporan...",
      characterCount:
        "{{count}}/2000 karakter. Instruksi ini akan ditambahkan ke prompt saat membuat setiap bagian.",
      selectKnowledgeBaseTitle: "Pilih Basis Pengetahuan",
      selectDocumentOutlineTitle: "Pilih Struktur Dokumen",
      generateButton: "Buat",
      results: "Hasil",
      copyText: "Salin Teks",
      copied: "Disalin!",
      ...
      downloadCsv: "Unduh CSV",
      clearReport: "Hapus Laporan",
      resultsPlaceholder:
        "Hasil akan muncul di sini setelah pembuatan dokumen.",
      sectionsWithSources: "Bagian dengan Sumber",
      sectionNumber: "Bagian {number}: {title}",
      kbGenerated: "Dihasilkan oleh KB",
      rawText: "Teks mentah",
      viewSourceCitations: "Lihat Kutipan Sumber ({count})",
      documentCopiedSuccess: "Dokumen berhasil disalin ke clipboard",
      documentCopiedError: "Tidak dapat menyalin dokumen ke clipboard",
      documentDownloadSuccess: "Unduhan dokumen berhasil",
      documentDownloadError: "Unduhan dokumen gagal: {error}",
      csvDownloadSuccess: "Unduhan CSV berhasil",
      csvDownloadError: "Unduhan CSV gagal: {error}",
      reportClearedSuccess: "Laporan yang dibuat telah dihapus",
      enterAtLeastOneSection: "Harap masukkan setidaknya satu bagian",
      selectKnowledgeBase: "Harap pilih basis pengetahuan",
      generateSuccess: "Laporan berhasil dibuat!",
      matchSuccess: "Pemrosesan formulir berhasil diselesaikan!",
      generateError: "Pembuatan dokumen gagal: {error}",
      vectorSearch: "pencarian vektor",
      fullDocumentScan: "pemindaian dokumen lengkap",
      editOutline: "Edit Struktur",
    },
  }
  ...
  resources.ms = {
    ...
    generate: {
      pageDescription:
        "Buat dokumen berdasarkan struktur yang ditentukan pengguna dan pangkalan data dokumen.",
      generatingDocument: "Membuat dokumen...",
      pleaseWait: "Sila tunggu sementara kami membuat laporan anda",
      knowledgeBaseTitle: "Pangkalan Pengetahuan",
      documentOutlineTitle: "Struktur Dokumen",
      clickToSelect: "Klik untuk pilih",
      customInstructionsTitle: "Arahan Tersuai (Pilihan)",
      customInstructionsPlaceholder:
        "Masukkan sebarang arahan tambahan yang perlu dipertimbangkan semasa membuat setiap bahagian laporan...",
      characterCount:
        "{{count}}/2000 aksara. Arahan ini akan ditambahkan ke prompt semasa membuat setiap bahagian.",
      selectKnowledgeBaseTitle: "Pilih Pangkalan Pengetahuan",
      selectDocumentOutlineTitle: "Pilih Struktur Dokumen",
      generateButton: "Jana",
      results: "Keputusan",
      ...
      downloadCsv: "Muat Turun CSV",
      clearReport: "Padam Laporan",
      resultsPlaceholder:
        "Keputusan akan muncul di sini selepas pembuatan dokumen.",
      sectionsWithSources: "Bahagian dengan Sumber",
      sectionNumber: "Bahagian {number}: {title}",
      kbGenerated: "Dijana oleh KB",
      rawText: "Teks mentah",
      viewSourceCitations: "Lihat Petikan Sumber ({count})",
      documentCopiedSuccess: "Dokumen berjaya disalin ke clipboard",
      documentCopiedError: "Tidak dapat menyalin dokumen ke clipboard",
      documentDownloadSuccess: "Muat turun dokumen berjaya",
      documentDownloadError: "Muat turun dokumen gagal: {error}",
      csvDownloadSuccess: "Muat turun CSV berjaya",
      csvDownloadError: "Muat turun CSV gagal: {error}",
      reportClearedSuccess: "Laporan yang dijana telah dipadam",
      enterAtLeastOneSection: "Sila masukkan sekurang-kurangnya satu bahagian",
      selectKnowledgeBase: "Sila pilih pangkalan pengetahuan",
      generateSuccess: "Laporan berjaya dijana!",
      matchSuccess: "Pemprosesan borang berjaya diselesaikan!",
      generateError: "Pembuatan dokumen gagal: {error}",
      vectorSearch: "carian vektor",
      fullDocumentScan: "imbasan dokumen penuh",
      editOutline: "Edit Struktur",
    },
  }
  ...
  resources.tl = {
    ...
    generate: {
      pageDescription:
        "Lumikha ng dokumento batay sa user-defined na istraktura at database ng dokumento.",
      generatingDocument: "Lumilikha ng dokumento...",
      pleaseWait: "Mangyaring maghintay habang ginagawa namin ang iyong ulat",
      knowledgeBaseTitle: "Knowledge Base",
      documentOutlineTitle: "Istruktura ng Dokumento",
      clickToSelect: "I-click upang pumili",
      customInstructionsTitle: "Mga Custom na Instruksyon (Opsyonal)",
      customInstructionsPlaceholder:
        "Ilagay ang anumang karagdagang instruksyon na dapat isaalang-alang kapag lumilikha ng bawat bahagi ng ulat...",
      characterCount:
        "{{count}}/2000 character. Ang mga instruksyon na ito ay idaragdag sa prompt kapag lumilikha ng bawat bahagi.",
      selectKnowledgeBaseTitle: "Pumili ng Knowledge Base",
      selectDocumentOutlineTitle: "Pumili ng Istruktura ng Dokumento",
      generateButton: "Lumikha",
      results: "Mga Resulta",
      copyText: "Kopyahin ang Teksto",
      copied: "Nakopya!",
      downloadDocx: "I-download ang DOCX",
      downloadCsv: "I-download ang CSV",
      clearReport: "Burahin ang Ulat",
      resultsPlaceholder:
        "Ang mga resulta ay lalabas dito pagkatapos ng paglikha ng dokumento.",
      sectionsWithSources: "Mga Bahagi na may Mga Pinagmulan",
      sectionNumber: "Bahagi {number}: {title}",
      kbGenerated: "Nabuo ng KB",
      rawText: "Hilaw na teksto",
      viewSourceCitations: "Tingnan ang Mga Sipi ng Pinagmulan ({count})",
      documentCopiedSuccess: "Matagumpay na nakopya ang dokumento sa clipboard",
      documentCopiedError: "Hindi makopya ang dokumento sa clipboard",
      documentDownloadSuccess: "Matagumpay ang pag-download ng dokumento",
      documentDownloadError: "Nabigo ang pag-download ng dokumento: {error}",
      csvDownloadSuccess: "Matagumpay ang pag-download ng CSV",
      csvDownloadError: "Nabigo ang pag-download ng CSV: {error}",
      reportClearedSuccess: "Ang nabuong ulat ay nabura na",
      enterAtLeastOneSection: "Mangyaring maglagay ng kahit isang bahagi",
      selectKnowledgeBase: "Mangyaring pumili ng knowledge base",
      generateSuccess: "Matagumpay na nabuo ang ulat!",
      matchSuccess: "Matagumpay na natapos ang pagproseso ng form!",
      generateError: "Nabigo ang paglikha ng dokumento: {error}",
      vectorSearch: "vector search",
      fullDocumentScan: "buong pag-scan ng dokumento",
      editOutline: "I-edit ang Istruktura",
    },
  }
  ...
  if (!resources.ja.common.archive) {
    resources.ja.common.archive = {
      ...
      feedback: {
        modalTitlePositive: "何が役に立ちましたか？",
        modalTitleNegative: "何を改善できますか？",
        descriptionPositive: "この回答で気に入った点を教えてください。",
        descriptionNegative: "この回答をどのように改善できるか教えてください。",
        placeholder: "あなたのコメント（任意）",
        cancel: "キャンセル",
        updateFeedback: "フィードバックを更新",
        submit: "送信",
        tooltipEditPositive: "役立つフィードバックを編集",
        tooltipMarkPositive: "役立つとしてマーク",
        tooltipEditNegative: "改善のためのフィードバックを編集",
  ...
  if (!resources.hi.common.archive) {
    resources.hi.common.archive = {
      ...
      feedback: {
        modalTitlePositive: "क्या उपयोगी था?",
        modalTitleNegative: "क्या सुधारा जा सकता है?",
        descriptionPositive: "हमें बताएं कि आपको इस उत्तर में क्या पसंद आया।",
        descriptionNegative: "हमें बताएं कि हम इस उत्तर को कैसे सुधार सकते हैं।",
        placeholder: "आपकी टिप्पणियां (वैकल्पिक)",
        cancel: "रद्द करें",
        updateFeedback: "फीडबैक अपडेट करें",
        submit: "सबमिट करें",
        tooltipEditPositive: "अपने उपयोगी फीडबैक को संपादित करें",
        tooltipMarkPositive: "उपयोगी के रूप में चिह्नित करें",
        tooltipEditNegative: "सुधार के लिए अपना फीडबैक संपादित करें",
        tooltipMarkNegative: "अनुपयोगी के रूप में चिह्नित करें",
        feedbackSaved: "फीडबैक सहेजा गया",
        thankYouMessage: "आपके फीडबैक के लिए धन्यवाद!",
        submitErrorMessage: "फीडबैक सबमिट करने में विफल। कृपया पुनः प्रयास करें।",
      },
      emptyMessages: {
  ...
  if (!resources.th.common.archive) {
    resources.th.common.archive = {
      ...
      feedback: {
        modalTitlePositive: "อะไรที่เป็นประโยชน์?",
        modalTitleNegative: "อะไรที่สามารถปรับปรุงได้?",
        descriptionPositive: "บอกเราเกี่ยวกับสิ่งที่คุณชอบในคำตอบนี้",
        descriptionNegative: "บอกเราเกี่ยวกับวิธีที่เราสามารถปรับปรุงคำตอบนี้",
        placeholder: "ความคิดเห็นของคุณ (ไม่บังคับ)",
        cancel: "ยกเลิก",
        updateFeedback: "อัปเดตข้อเสนอแนะ",
        submit: "ส่ง",
        tooltipEditPositive: "แก้ไขข้อเสนอแนะที่มีประโยชน์ของคุณ",
        tooltipMarkPositive: "ทำเครื่องหมายว่ามีประโยชน์",
        tooltipEditNegative: "แก้ไขข้อเสนอแนะของคุณสำหรับการปรับปรุง",
        tooltipMarkNegative: "ทำเครื่องหมายว่าไม่มีประโยชน์",
        feedbackSaved: "บันทึกข้อเสนอแนะแล้ว",
        thankYouMessage: "ขอบคุณสำหรับข้อเสนอแนะของคุณ!",
        submitErrorMessage: "ส่งข้อเสนอแนะไม่สำเร็จ กรุณาลองอีกครั้ง",
      },
      emptyMessages: {
  ...
  if (!resources.vi.common.archive) {
    resources.vi.common.archive = {
      ...
      feedback: {
        ...
        submit: "Gửi",
        tooltipEditPositive: "Chỉnh sửa phản hồi hữu ích của bạn",
        tooltipMarkPositive: "Đánh dấu là hữu ích",
        tooltipEditNegative: "Chỉnh sửa phản hồi của bạn để cải thiện",
        tooltipMarkNegative: "Đánh dấu là không hữu ích",
        feedbackSaved: "Phản hồi đã được lưu",
        thankYouMessage: "Cảm ơn bạn đã phản hồi!",
        submitErrorMessage: "Gửi phản hồi thất bại. Vui lòng thử lại.",
      },
      emptyMessages: {
  ...
  if (!resources.id.common.archive) {
    resources.id.common.archive = {
      ...
      feedback: {
        ...
        submit: "Kirim",
        tooltipEditPositive: "Edit umpan balik berguna Anda",
        tooltipMarkPositive: "Tandai sebagai berguna",
        tooltipEditNegative: "Edit umpan balik Anda untuk perbaikan",
        tooltipMarkNegative: "Tandai sebagai tidak berguna",
        feedbackSaved: "Umpan balik disimpan",
        thankYouMessage: "Terima kasih atas umpan balik Anda!",
        submitErrorMessage: "Gagal mengirim umpan balik. Silakan coba lagi.",
      },
      emptyMessages: {
  ...
  if (!resources.ms.common.archive) {
    resources.ms.common.archive = {
      ...
      feedback: {
        ...
        submit: "Hantar",
        tooltipEditPositive: "Edit maklum balas berguna anda",
        tooltipMarkPositive: "Tandakan sebagai berguna",
        tooltipEditNegative: "Edit maklum balas anda untuk penambahbaikan",
        tooltipMarkNegative: "Tandakan sebagai tidak berguna",
        feedbackSaved: "Maklum balas disimpan",
        thankYouMessage: "Terima kasih atas maklum balas anda!",
        submitErrorMessage: "Gagal menghantar maklum balas. Sila cuba lagi.",
      },
      emptyMessages: {
