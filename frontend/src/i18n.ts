...
const generateAllLanguageResources = () => {
  ...
  resources.en = {
    common: {
      ...
      review: {
        ...
        reviewSuccess: "Document review completed successfully!",
        reviewSuccessMultiple: "{{count}} files processed with optimized context sharing!",
      },
      generate: {
        pageDescription:
      ...
      archive: {
        ...
        successMessages: {
          evaluationLoaded: "Evaluation loaded successfully",
          reportLoaded: "Report loaded successfully",
          comparisonLoaded: "Comparison loaded successfully",
          formProcessingLoaded: "Form processing loaded successfully",
          evaluationDeleted: "Evaluation deleted successfully",
          reportDeleted: "Report deleted successfully",
          comparisonDeleted: "Comparison deleted successfully",
          formProcessingDeleted: "Form processing deleted successfully",
        },
      },
      common: {
        loading: "Loading...",
      ...
      feedback: {
        modalTitlePositive: "What was helpful?",
        modalTitleNegative: "What could be improved?",
        descriptionPositive: "Tell us what you liked about this response.",
        descriptionNegative: "Tell us how we can improve this response.",
        placeholder: "Your comments (optional)",
        cancel: "Cancel",
        updateFeedback: "Update Feedback",
        submit: "Submit",
        tooltipEditPositive: "Edit your helpful feedback",
        tooltipMarkPositive: "Mark as helpful",
        tooltipEditNegative: "Edit your feedback for improvements",
        tooltipMarkNegative: "Mark as not helpful",
  ...
  resources.es = {
    common: {
      ...
      review: {
        ...
        reviewSuccess: "¡Revisión de documento completada exitosamente!",
      ...
      match: {
        ...
        matchSuccess: "¡Procesamiento de formulario completado exitosamente!",
      },
      editFormTemplateModal: {
      ...
      feedback: {
        ...
        modalTitleNegative: "¿Qué se podría mejorar?",
        ...
        cancel: "Cancelar",
        updateFeedback: "Actualizar Comentarios",
        submit: "Enviar",
        tooltipEditPositive: "Editar tus comentarios positivos",
        tooltipMarkPositive: "Marcar como útil",
        tooltipEditNegative: "Editar tus comentarios de mejora",
        tooltipMarkNegative: "Marcar como no útil",
        feedbackSaved: "Comentarios guardados",
        thankYouMessage: "¡Gracias por tus comentarios!",
        submitErrorMessage: "Error al enviar comentarios. Por favor intenta nuevamente.",
      },
    },
  }
  ...
  resources.fr = {
    common: {
      ...
      match: {
        ...
        matchSuccess: "Traitement du formulaire terminé avec succès !",
      },
      editFormTemplateModal: {
      ...
      feedback: {
        modalTitlePositive: "Qu'est-ce qui était utile ?",
        modalTitleNegative: "Qu'est-ce qui pourrait être amélioré ?",
        descriptionPositive: "Dites-nous ce que vous avez aimé dans cette réponse.",
        descriptionNegative: "Dites-nous comment nous pouvons améliorer cette réponse.",
        placeholder: "Vos commentaires (optionnel)",
        cancel: "Annuler",
        updateFeedback: "Mettre à Jour les Commentaires",
        submit: "Envoyer",
        tooltipEditPositive: "Modifier vos commentaires positifs",
        tooltipMarkPositive: "Marquer comme utile",
        tooltipEditNegative: "Modifier vos commentaires d'amélioration",
        tooltipMarkNegative: "Marquer comme non utile",
        feedbackSaved: "Commentaires sauvegardés",
        thankYouMessage: "Merci pour vos commentaires !",
        submitErrorMessage: "Échec de l'envoi des commentaires. Veuillez réessayer.",
      },
    },
  }
  ...
  resources.de = {
    common: {
      ...
      match: {
        ...
        matchSuccess: "Formularverarbeitung erfolgreich abgeschlossen!",
      },
      editFormTemplateModal: {
      ...
      feedback: {
        modalTitlePositive: "Was war hilfreich?",
        modalTitleNegative: "Was könnte verbessert werden?",
        descriptionPositive: "Sagen Sie uns, was Ihnen an dieser Antwort gefallen hat.",
        descriptionNegative: "Sagen Sie uns, wie wir diese Antwort verbessern können.",
        placeholder: "Ihre Kommentare (optional)",
        cancel: "Abbrechen",
        updateFeedback: "Feedback Aktualisieren",
        submit: "Senden",
        tooltipEditPositive: "Ihr positives Feedback bearbeiten",
        tooltipMarkPositive: "Als hilfreich markieren",
        tooltipEditNegative: "Ihr Verbesserungsfeedback bearbeiten",
        tooltipMarkNegative: "Als nicht hilfreich markieren",
        feedbackSaved: "Feedback gespeichert",
        thankYouMessage: "Vielen Dank für Ihr Feedback!",
        submitErrorMessage: "Feedback konnte nicht gesendet werden. Bitte versuchen Sie es erneut.",
      },
    },
  }
  ...
  resources.it = {
    common: {
      ...
      generate: {
        ...
        selectKnowledgeBase: "Seleziona una base di conoscenza",
        generateSuccess: "Rapporto generato con successo!",
      ...
      match: {
        ...
        matchSuccess: "Elaborazione modulo completata con successo!",
      },
      editFormTemplateModal: {
      ...
      feedback: {
        modalTitlePositive: "Cosa è stato utile?",
        modalTitleNegative: "Cosa potrebbe essere migliorato?",
        descriptionPositive: "Dicci cosa ti è piaciuto di questa risposta.",
        descriptionNegative: "Dicci come possiamo migliorare questa risposta.",
        placeholder: "I tuoi commenti (opzionale)",
        cancel: "Annulla",
        updateFeedback: "Aggiorna Feedback",
        submit: "Invia",
        tooltipEditPositive: "Modifica il tuo feedback positivo",
        tooltipMarkPositive: "Segna come utile",
        tooltipEditNegative: "Modifica il tuo feedback per miglioramenti",
        tooltipMarkNegative: "Segna come non utile",
        feedbackSaved: "Feedback salvato",
        thankYouMessage: "Grazie per il tuo feedback!",
        submitErrorMessage: "Invio del feedback fallito. Riprova.",
      },
    },
  }
  ...
  resources.pt = {
    common: {
      ...
      match: {
        ...
        matchSuccess: "Processamento de formulário concluído com sucesso!",
      },
      editFormTemplateModal: {
      ...
      feedback: {
        ...
        modalTitleNegative: "O que poderia ser melhorado?",
        descriptionPositive: "Conte-nos o que gostou nesta resposta.",
        ...
        submit: "Enviar",
        tooltipEditPositive: "Editar seu feedback positivo",
        tooltipMarkPositive: "Marcar como útil",
        tooltipEditNegative: "Editar seu feedback de melhorias",
        tooltipMarkNegative: "Marcar como não útil",
        feedbackSaved: "Feedback salvo",
        thankYouMessage: "Obrigado pelo seu feedback!",
        submitErrorMessage: "Falha ao enviar feedback. Tente novamente.",
      },
    },
  }
  ...
  resources.ru = {
    common: {
      ...
      match: {
        ...
        matchSuccess: "Обработка формы успешно завершена!",
      },
      editFormTemplateModal: {
      ...
      knowledgeBases: {
        ...
        feedback: {
          modalTitlePositive: "Что было полезным?",
          modalTitleNegative: "Что можно улучшить?",
          descriptionPositive: "Расскажите, что вам понравилось в этом ответе.",
          descriptionNegative: "Расскажите, как мы можем улучшить этот ответ.",
          placeholder: "Ваши комментарии (необязательно)",
          cancel: "Отмена",
          updateFeedback: "Обновить отзыв",
          submit: "Отправить",
          tooltipEditPositive: "Редактировать ваш положительный отзыв",
          tooltipMarkPositive: "Отметить как полезное",
          tooltipEditNegative: "Редактировать ваш отзыв об улучшениях",
          tooltipMarkNegative: "Отметить как бесполезное",
          feedbackSaved: "Отзыв сохранен",
          thankYouMessage: "Спасибо за ваш отзыв!",
          submitErrorMessage: "Не удалось отправить отзыв. Попробуйте еще раз.",
        },
      },
    },
  }
  ...
  resources.zh = {
    common: {
      ...
      feedback: {
        modalTitlePositive: "什么是有用的？",
        modalTitleNegative: "什么可以改进？",
        descriptionPositive: "告诉我们您喜欢这个回答的什么。",
        descriptionNegative: "告诉我们如何改进这个回答。",
        placeholder: "您的评论（可选）",
        cancel: "取消",
        updateFeedback: "更新反馈",
        submit: "提交",
        tooltipEditPositive: "编辑您的正面反馈",
        tooltipMarkPositive: "标记为有用",
        tooltipEditNegative: "编辑您的改进反馈",
        tooltipMarkNegative: "标记为无用",
        feedbackSaved: "反馈已保存",
        thankYouMessage: "感谢您的反馈！",
        submitErrorMessage: "提交反馈失败。请重试。",
      },
    },
  }
  ...
  resources.ja = {
    common: {
      ...
      feedback: {
        modalTitlePositive: "役に立った点は？",
        modalTitleNegative: "改善できる点は？",
        descriptionPositive: "この回答で気に入った点を教えてください。",
        descriptionNegative: "この回答を改善する方法を教えてください。",
        placeholder: "コメント（任意）",
        cancel: "キャンセル",
        updateFeedback: "フィードバックを更新",
        submit: "送信",
        tooltipEditPositive: "肯定的なフィードバックを編集",
        tooltipMarkPositive: "役立つとしてマーク",
        tooltipEditNegative: "改善フィードバックを編集",
        tooltipMarkNegative: "役立たないとしてマーク",
        feedbackSaved: "フィードバックを保存しました",
        thankYouMessage: "フィードバックありがとうございます！",
        submitErrorMessage: "フィードバックの送信に失敗しました。再度お試しください。",
      },
    },
  }
  ...
  resources.uk = {
    common: {
      ...
      generate: {
        pageDescription:
          "Створити документ на основі визначеного користувачем плану та бази даних документів.",
        generatingDocument: "Створення документа...",
        pleaseWait: "Будь ласка, зачекайте, поки ми створюємо ваш звіт",
        knowledgeBaseTitle: "База Знань",
        documentOutlineTitle: "План Документа",
        clickToSelect: "Натисніть для вибору",
        customInstructionsTitle: "Користувацькі Інструкції (Необов'язково)",
        customInstructionsPlaceholder:
          "Введіть будь-які додаткові інструкції, які слід враховувати при створенні кожного розділу звіту...",
        characterCount:
          "{{count}}/2000 символів. Ці інструкції будуть додані до запиту при створенні кожного розділу.",
        selectKnowledgeBaseTitle: "Вибрати Базу Знань",
        selectDocumentOutlineTitle: "Вибрати План Документа",
        ...
        downloadCsv: "Завантажити CSV",
        clearReport: "Очистити Звіт",
        resultsPlaceholder:
          "Результати з'являться тут після створення документа.",
        sectionsWithSources: "Розділи з Джерелами",
        sectionNumber: "Розділ {number}: {title}",
        kbGenerated: "КБ Створено",
        rawText: "Сирий Текст",
        viewSourceCitations: "Переглянути Цитати Джерел ({count})",
        documentCopiedSuccess: "Документ скопійовано в буфер обміну",
        documentCopiedError: "Не вдалося скопіювати документ в буфер обміну",
        documentDownloadSuccess: "Документ успішно завантажено",
        documentDownloadError: "Не вдалося завантажити документ: {error}",
        csvDownloadSuccess: "CSV успішно завантажено",
        csvDownloadError: "Не вдалося завантажити CSV: {error}",
        reportClearedSuccess: "Створений звіт очищено",
        enterAtLeastOneSection: "Будь ласка, введіть принаймні один розділ",
        selectKnowledgeBase: "Будь ласка, виберіть базу знань",
        generateSuccess: "Звіт створено успішно!",
        generateError: "Не вдалося створити документ: {error}",
        vectorSearch: "векторний пошук",
        fullDocumentScan: "повний аналіз документа",
        matchSuccess: "Обробку форми завершено успішно!",
      },
      compare: {
  ...
  resources.pl = {
    common: {
      ...
      generate: {
        pageDescription:
          "Wygeneruj dokument na podstawie zdefiniowanego przez użytkownika konspektu i bazy danych dokumentów.",
        generatingDocument: "Generowanie dokumentu...",
        pleaseWait: "Proszę czekać, podczas gdy generujemy Twój raport",
        knowledgeBaseTitle: "Baza Wiedzy",
        documentOutlineTitle: "Konspekt Dokumentu",
        clickToSelect: "Kliknij, aby wybrać",
        customInstructionsTitle: "Instrukcje Niestandardowe (Opcjonalne)",
        customInstructionsPlaceholder:
          "Wprowadź dodatkowe instrukcje, które powinny być uwzględnione podczas generowania każdej sekcji raportu...",
        characterCount:
          "{{count}}/2000 znaków. Te instrukcje zostaną dodane do zapytania podczas generowania każdej sekcji.",
        selectKnowledgeBaseTitle: "Wybierz Bazę Wiedzy",
        selectDocumentOutlineTitle: "Wybierz Konspekt Dokumentu",
        ...
        downloadCsv: "Pobierz CSV",
        clearReport: "Wyczyść Raport",
        resultsPlaceholder:
          "Wyniki pojawią się tutaj po wygenerowaniu dokumentu.",
        sectionsWithSources: "Sekcje ze Źródłami",
        sectionNumber: "Sekcja {number}: {title}",
        kbGenerated: "KB Wygenerowane",
        rawText: "Surowy Tekst",
        viewSourceCitations: "Zobacz Cytaty Źródłowe ({count})",
        documentCopiedSuccess: "Dokument skopiowany do schowka",
        documentCopiedError: "Nie udało się skopiować dokumentu do schowka",
        documentDownloadSuccess: "Dokument pobrany pomyślnie",
        documentDownloadError: "Nie udało się pobrać dokumentu: {error}",
        csvDownloadSuccess: "CSV pobrane pomyślnie",
        csvDownloadError: "Nie udało się pobrać CSV: {error}",
        reportClearedSuccess: "Wygenerowany raport wyczyszczony",
        enterAtLeastOneSection: "Proszę wprowadzić przynajmniej jedną sekcję",
        selectKnowledgeBase: "Proszę wybrać bazę wiedzy",
        generateSuccess: "Raport wygenerowany pomyślnie!",
        generateError: "Nie udało się wygenerować dokumentu: {error}",
        vectorSearch: "wyszukiwanie wektorowe",
        fullDocumentScan: "pełna analiza dokumentu",
        matchSuccess: "Przetwarzanie formularza zakończone pomyślnie!",
      },
      modelSelection: {
  ...
  resources.nl = {
    common: {
      ...
      generate: {
        pageDescription:
          "Genereer een document op basis van een door de gebruiker gedefinieerde outline en documentendatabase.",
        generatingDocument: "Document genereren...",
        pleaseWait: "Even geduld terwijl we uw rapport genereren",
        knowledgeBaseTitle: "Kennisbank",
        documentOutlineTitle: "Document Outline",
        clickToSelect: "Klik om te selecteren",
        customInstructionsTitle: "Aangepaste Instructies (Optioneel)",
        customInstructionsPlaceholder:
          "Voer aanvullende instructies in die moeten worden overwogen bij het genereren van elke sectie van het rapport...",
        characterCount:
          "{{count}}/2000 tekens. Deze instructies worden toegevoegd aan de prompt bij het genereren van elke sectie.",
        selectKnowledgeBaseTitle: "Kennisbank Selecteren",
        selectDocumentOutlineTitle: "Document Outline Selecteren",
        ...
        resultsPlaceholder:
          "Resultaten verschijnen hier na het genereren van een document.",
        sectionsWithSources: "Secties met Bronnen",
        sectionNumber: "Sectie {number}: {title}",
        kbGenerated: "KB Gegenereerd",
        rawText: "Ruwe Tekst",
        viewSourceCitations: "Broncitaten Bekijken ({count})",
        documentCopiedSuccess: "Document gekopieerd naar klembord",
        documentCopiedError: "Kon document niet naar klembord kopiëren",
        documentDownloadSuccess: "Document succesvol gedownload",
        documentDownloadError: "Kon document niet downloaden: {error}",
        csvDownloadSuccess: "CSV succesvol gedownload",
        csvDownloadError: "Kon CSV niet downloaden: {error}",
        reportClearedSuccess: "Gegenereerd rapport gewist",
        enterAtLeastOneSection: "Voer minimaal één sectie in",
        selectKnowledgeBase: "Selecteer een kennisbank",
        generateSuccess: "Rapport succesvol gegenereerd!",
        generateError: "Kon document niet genereren: {error}",
        vectorSearch: "vector zoeken",
        fullDocumentScan: "volledige document analyse",
        matchSuccess: "Formulierverwerking succesvol voltooid!",
      },
      modelSelection: {
  ...
  resources.ko = {
    common: {
      ...
      match: {
        ...
        matchSuccess: "양식 처리가 성공적으로 완료되었습니다!",
      },
      editFormTemplateModal: {
        title: "양식 템플릿 편집",
      ...
      feedback: {
        modalTitlePositive: "유용한 점은 무엇인가요?",
        modalTitleNegative: "개선할 수 있는 점은 무엇인가요?",
        descriptionPositive: "이 답변에서 마음에 들었던 점을 알려주세요.",
        descriptionNegative: "이 답변을 개선할 방법을 알려주세요.",
        placeholder: "댓글 (선택사항)",
        cancel: "취소",
        updateFeedback: "피드백 업데이트",
        submit: "제출",
        tooltipEditPositive: "긍정적 피드백 편집",
        tooltipMarkPositive: "유용함으로 표시",
        tooltipEditNegative: "개선 피드백 편집",
        tooltipMarkNegative: "유용하지 않음으로 표시",
        feedbackSaved: "피드백이 저장되었습니다",
        thankYouMessage: "피드백 감사합니다!",
        submitErrorMessage: "피드백 제출에 실패했습니다. 다시 시도해 주세요.",
      },
    },
  }
  ...
  resources.ar = {
    common: {
      ...
      generate: {
        pageDescription:
          "إنشاء مستند بناءً على مخطط محدد من قبل المستخدم وقاعدة بيانات المستندات.",
        generatingDocument: "جاري إنشاء المستند...",
        pleaseWait: "يرجى الانتظار أثناء إنشاء التقرير الخاص بك",
        knowledgeBaseTitle: "قاعدة المعرفة",
        documentOutlineTitle: "مخطط المستند",
        clickToSelect: "انقر للتحديد",
        customInstructionsTitle: "تعليمات مخصصة (اختياري)",
        customInstructionsPlaceholder:
          "أدخل أي تعليمات إضافية يجب مراعاتها عند إنشاء كل قسم من التقرير...",
        characterCount:
          "{{count}}/2000 حرف. ستُضاف هذه التعليمات إلى الطلب عند إنشاء كل قسم.",
        selectKnowledgeBaseTitle: "تحديد قاعدة المعرفة",
        selectDocumentOutlineTitle: "تحديد مخطط المستند",
        ...
        resultsPlaceholder:
          "ستظهر النتائج هنا بعد إنشاء المستند.",
        sectionsWithSources: "أقسام مع مصادر",
        sectionNumber: "القسم {number}: {title}",
        kbGenerated: "كيلو بايت مُنشأ",
        rawText: "نص خام",
        viewSourceCitations: "عرض اقتباسات المصدر ({count})",
        documentCopiedSuccess: "تم نسخ المستند إلى الحافظة",
        documentCopiedError: "فشل في نسخ المستند إلى الحافظة",
        documentDownloadSuccess: "تم تحميل المستند بنجاح",
        documentDownloadError: "فشل في تحميل المستند: {error}",
        csvDownloadSuccess: "تم تحميل CSV بنجاح",
        csvDownloadError: "فشل في تحميل CSV: {error}",
        reportClearedSuccess: "تم مسح التقرير المُنشأ",
        enterAtLeastOneSection: "يرجى إدخال قسم واحد على الأقل",
        selectKnowledgeBase: "يرجى تحديد قاعدة معرفة",
        generateSuccess: "تم إنشاء التقرير بنجاح!",
        generateError: "فشل في إنشاء المستند: {error}",
        vectorSearch: "البحث المتجه",
        fullDocumentScan: "تحليل المستند الكامل",
        matchSuccess: "تم إكمال معالجة النموذج بنجاح!",
      },
      editFormTemplateModal: {
      ...
      feedback: {
        modalTitlePositive: "ما الذي كان مفيداً؟",
        modalTitleNegative: "ما الذي يمكن تحسينه؟",
        descriptionPositive: "أخبرنا ما أعجبك في هذه الإجابة.",
        descriptionNegative: "أخبرنا كيف يمكننا تحسين هذه الإجابة.",
        placeholder: "تعليقاتك (اختياري)",
        cancel: "إلغاء",
        updateFeedback: "تحديث التعليقات",
        submit: "إرسال",
        tooltipEditPositive: "تحرير تعليقاتك الإيجابية",
        tooltipMarkPositive: "وضع علامة كمفيد",
        tooltipEditNegative: "تحرير تعليقات التحسين الخاصة بك",
        tooltipMarkNegative: "وضع علامة كغير مفيد",
        feedbackSaved: "تم حفظ التعليقات",
        thankYouMessage: "شكراً لتعليقاتك!",
        submitErrorMessage: "فشل في إرسال التعليقات. يرجى المحاولة مرة أخرى.",
      },
    },
  }
  ...
  resources.hi = {
    common: {
      ...
      generate: {
        pageDescription:
          "उपयोगकर्ता-परिभाषित आउटलाइन और दस्तावेज़ डेटाबेस के आधार पर दस्तावेज़ उत्पन्न करें।",
        generatingDocument: "दस्तावेज़ उत्पन्न हो रहा है...",
        pleaseWait: "कृपया प्रतीक्षा करें जबकि हम आपकी रिपोर्ट उत्पन्न करते हैं",
        knowledgeBaseTitle: "ज्ञान आधार",
        documentOutlineTitle: "दस्तावेज़ आउटलाइन",
        clickToSelect: "चयन करने के लिए क्लिक करें",
        customInstructionsTitle: "कस्टम निर्देश (वैकल्पिक)",
        customInstructionsPlaceholder:
          "रिपोर्ट के प्रत्येक अनुभाग को उत्पन्न करते समय विचार किए जाने वाले अतिरिक्त निर्देश दर्ज करें...",
        characterCount:
          "{{count}}/2000 वर्ण। ये निर्देश प्रत्येक अनुभाग उत्पन्न करते समय प्रॉम्प्ट में जोड़े जाएंगे।",
        selectKnowledgeBaseTitle: "ज्ञान आधार चुनें",
        selectDocumentOutlineTitle: "दस्तावेज़ आउटलाइन चुनें",
        ...
        resultsPlaceholder:
          "दस्तावेज़ उत्पन्न करने के बाद परिणाम यहां दिखाई देंगे।",
        sectionsWithSources: "स्रोतों के साथ अनुभाग",
        sectionNumber: "अनुभाग {number}: {title}",
        kbGenerated: "KB उत्पन्न",
        rawText: "कच्चा पाठ",
        viewSourceCitations: "स्रोत उद्धरण देखें ({count})",
        documentCopiedSuccess: "दस्तावेज़ क्लिपबोर्ड में कॉपी किया गया",
        documentCopiedError: "दस्तावेज़ को क्लिपबोर्ड में कॉपी करने में विफल",
        documentDownloadSuccess: "दस्तावेज़ सफलतापूर्वक डाउनलोड किया गया",
        documentDownloadError: "दस्तावेज़ डाउनलोड करने में विफल: {error}",
        csvDownloadSuccess: "CSV सफलतापूर्वक डाउनलोड किया गया",
        csvDownloadError: "CSV डाउनलोड करने में विफल: {error}",
        reportClearedSuccess: "उत्पन्न रिपोर्ट साफ़ की गई",
        enterAtLeastOneSection: "कृपया कम से कम एक अनुभाग दर्ज करें",
        selectKnowledgeBase: "कृपया एक ज्ञान आधार चुनें",
        generateSuccess: "रिपोर्ट सफलतापूर्वक उत्पन्न की गई!",
        generateError: "दस्तावेज़ उत्पन्न करने में विफल: {error}",
        vectorSearch: "वेक्टर खोज",
        fullDocumentScan: "पूर्ण दस्तावेज़ स्कैन",
        matchSuccess: "फॉर्म प्रोसेसिंग सफलतापूर्वक पूरी हुई!",
      },
      editFormTemplateModal: {
