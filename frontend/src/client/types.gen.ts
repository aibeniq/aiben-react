...
export type Body_formconnect_generate_form_fields_with_files = {
    description: string;
    num_fields?: number;
...
export type Body_twincheck_generate_topics = {
    description: string;
...
export type EmbeddingModelsGetDefaultEmbeddingModelResponse = (EmbeddingModelPublic);
...
export type EmbeddingModelsSetDefaultEmbeddingModelResponse = (EmbeddingModelPublic);
...
export type FormconnectGenerateFormFieldsData = {
    requestBody: GenerateFormFieldsRequest;
};

export type FormconnectGenerateFormFieldsResponse = (GenerateFormFieldsResponse);

export type FormconnectGenerateFormFieldsJsonData = {
    requestBody: GenerateFormFieldsRequest;
};

export type FormconnectGenerateFormFieldsJsonResponse = (GenerateFormFieldsResponse);

export type FormconnectGenerateFormFieldsWithFilesData = {
    formData: Body_formconnect_generate_form_fields_with_files;
};

export type FormconnectGenerateFormFieldsWithFilesResponse = (GenerateFormFieldsResponse);
...
export type ReportgenieGenerateOutlineJsonData = {
    requestBody: GenerateOutlineRequest;
};

export type ReportgenieGenerateOutlineJsonResponse = (GenerateOutlineResponse);
...
export type ReportgenieGenerateOutlineOptimizationCsvData = {
    requestBody: DocxRequest;
};
...
export type TwincheckGenerateTopicsResponse = (GenerateTopicsResponse);

export type TwincheckGenerateTopicsJsonData = {
...
export type UsageGetPageUsageResponse = (PageUsageResponse);
...
export type UtilsGetSystemConfigResponse = ({
    [key: string]: unknown;
});
...
export type VeradocGenerateOptimizationCsvData = {
    requestBody: DocxRequest;
};

export type VeradocGenerateOptimizationCsvResponse = (unknown);

export type VeradocGenerateQuestionsWithFilesData = {
    formData: Body_veradoc_generate_questions_with_files;
};

export type VeradocGenerateQuestionsWithFilesResponse = (GenerateQuestionsResponse);
