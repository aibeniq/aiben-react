...
import type {
  ...
  SubmitFeedbackApiV1ApiV1FeedbackPostData,
  SubmitFeedbackApiV1ApiV1FeedbackPostResponse,
...
export class FeedbackService {
  ...
  public static submitFeedback(
    data: SubmitFeedbackApiV1ApiV1FeedbackPostData,
...
export class VeradocService {
  ...
  public static generateQuestions(
    data: GenerateQuestionsApiV1VeradocGenerateQuestionsPostData,
  ): CancelablePromise<GenerateQuestionsApiV1VeradocGenerateQuestionsPostResponse> {
    return __request(OpenAPI, {
      method: "POST",
