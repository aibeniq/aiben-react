...
export class UsageService {
     ...
     * @returns PageUsageResponse Successful Response
     * @throws ApiError
     */
    public static getPageUsage(): CancelablePromise<UsageGetPageUsageResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/usage/page-usage'
        });
    }
