...
export class UsersService {
     ...
     * @throws ApiError
     */
    public static updateVisionAnalysisSetting(data: UpdateVisionAnalysisSettingApiV1UsersMeVisionAnalysisPutData): CancelablePromise<UpdateVisionAnalysisSettingApiV1UsersMeVisionAnalysisPutResponse> {
        return __request(OpenAPI, {
            method: 'PUT',
     ...
     * @throws ApiError
     */
    public static updatePdfParsingPreference(data: UpdatePdfParsingPreferenceApiV1UsersMePdfParsingPreferencePutData): CancelablePromise<UpdatePdfParsingPreferenceApiV1UsersMePdfParsingPreferencePutResponse> {
        return __request(OpenAPI, {
            method: 'PUT',
