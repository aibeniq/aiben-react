...
export class UsersService {
     ...
     * @throws ApiError
     */
    public static updateVisionAnalysis(data: UpdateVisionAnalysisApiV1UsersMeVisionAnalysisPutData): CancelablePromise<UpdateVisionAnalysisApiV1UsersMeVisionAnalysisPutResponse> {
        return __request(OpenAPI, {
            method: 'PUT',
